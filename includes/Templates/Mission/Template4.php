<?php
/**
 * Product recommendation + mission template.
 *
 * @package FaraCart
 */
 ...
 * Class Template4
 *
 * The product-recommendation mission card (Concept 07 — Product
 * Recommendation + Mission): a gradient progress header with the remaining
 * amount, followed by the mission's own recommended products (the existing
